RAID = [
    "MADARCHOD TERI MAA KI CHUT ME GHUTKA KHAAKE THOOK DUNGA #DS_OP🤣🤣",
    "TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA#DS_OP",
    "TERI MAA KA CHUT CHODU SHINCHAN BHAIYA KE MAKAN PAR",
]
