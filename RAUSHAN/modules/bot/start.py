...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("𝙾𝚆𝙽𝙴𝚁", url="t.me/X1OWNER"),
            ],
            [
                InlineKeyboardButton("𝙲𝙷𝙰𝙽𝙽𝙴𝙻", url="t.me/NLTRIDE"),
            ],
            [
                InlineKeyboardButton("𝚂𝚄𝙿𝙿𝙾𝚁𝚃", url="t.me/huntermafiya"),
            ],
            ]
